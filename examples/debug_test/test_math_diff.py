...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_rollouts", type=int, default=8, help="Number of rollouts per sample")
    parser.add_argument("--debug_samples", type=int, default=-1, help="Number of samples to run (set -1 for full dataset)")
