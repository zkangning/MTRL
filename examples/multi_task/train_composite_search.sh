...
export BRIGHT_DATA_API_TOKEN="cc3aa7328dff8a517d1b6940332b1f8b4ababc37b416a498217e1b7c2e130f11"
...
# ================= 启动训练 =================
python3 -m examples.multi_task.train_search \
    algorithm.adv_estimator=grpo \
    data.train_batch_size=64 \
    +data.math_num=0 \
    +data.code_num=0 \
    +data.bfcl_num=0 \
    +data.search_num=2560 \
    +data.dataset_name=math0_code0_search2560_bfcl0 \
    trainer.experiment_name='math0_code0_search2560_bfcl0-8b-mixed-tasks' \
    data.val_batch_size=64 \
    data.max_prompt_length=7168 \
    data.max_response_length=20992 \
    \
